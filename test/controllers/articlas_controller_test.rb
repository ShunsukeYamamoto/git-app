...
class ArticlasControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create articla" do
    assert_difference('Articla.count') do
      post articlas_url, params: { articla: { author: @articla.author, text: @articla.text, title: @articla.title } }
    end
  ...
  test "should update articla" do
    patch articla_url(@articla), params: { articla: { author: @articla.author, text: @articla.text, title: @articla.title } }
